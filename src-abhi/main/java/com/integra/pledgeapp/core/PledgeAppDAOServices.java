...
public interface PledgeAppDAOServices {
	...
	ArrayList<Sign_Doc_Details> getSignedDocListEmpidAndEmpGrp(String empid, String Empgrp);

	JSONObject removeBCInSignDocDetails(int numberToAppend, String empID, String empGrp) throws JSONException;
